    ...
    public class ArmadaServer
    {
        ...
        public async Task StartAsync()
        {
            ...
            _MissionLanding = new MissionLandingHandler(
                _Logging, _Database, _Settings, _Git, _MergeQueue, _LandingService, _AutoLandEvaluator, _ConventionChecker, _CriticalTriggerEvaluator, _TemplateService, _PromptTemplateService, _Docks, _RemoteTriggerService, null, _CodeIndex, _IncidentService);
