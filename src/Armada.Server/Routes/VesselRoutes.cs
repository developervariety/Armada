namespace Armada.Server.Routes
{
    ...
    public class VesselRoutes
    {
        ...
        /// <param name="readiness">Vessel readiness evaluator.</param>
        /// <param name="landingPreview">Landing preview evaluator.</param>
            ...
            string operation)
        {
            ...
            {
                return RouteAuthRefusal.Refuse(req, ctx, "Branch writes require an administrator for the vessel's tenant");
            }
            ...
            IAuthorizationService authz)
        {
            ...
            api => api
                ...
                .WithParameter(OpenApiParameterMetadata.Query("includeWorkflowRequirements", "When false, only vessel and repository basics are evaluated", false))
