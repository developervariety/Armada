namespace Armada.Server
{
    ...
    /// v0.8.0 ships the Armada-side tunnel foundation only: URL normalization,
        ...
        public RemoteTunnelCapabilityManifest BuildCapabilityManifest()
        {
            return new RemoteTunnelCapabilityManifest
            {
                ...
                Features = new List<string>
                {
                    ...
                    "backlog.update",
                    "backlog.delete",
                    "objective-refinement-sessions.list",
                    "objective-refinement-sessions.create",
                    "objective-refinement-session.detail",
                    "objective-refinement-session.message",
                    "objective-refinement-session.summarize",
                    "objective-refinement-session.apply",
                    "objective-refinement-session.stop",
                    "objective-refinement-session.delete",
                    "planning-sessions.list",
                    "planning-session.detail",
                    "planning-session.create",
                    "planning-session.message",
                    "planning-session.summarize",
                    "planning-session.dispatch",
                    "planning-session.stop",
                    "planning-session.delete",
                    "workflow-profiles.list",
                    "workflow-profile.detail",
                    ...
                    "runbook.update",
                    "runbook.delete",
                    "runbook-executions.list",
                    "runbook-execution.detail",
                    "runbook-execution.create",
                    "runbook-execution.update",
                    "runbook-execution.delete",
                    "captain.tools",
