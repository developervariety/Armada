            ...
            register(
                ...
                new
                {
                    ...
                    properties = new
                    {
                        ...
                        includeDescription = new { type = "boolean", description = "Include full Description on voyages (default false; returns descriptionLength hint when false). Mission enumeration always returns lightweight summaries; use mission-specific tools for details/logs/diffs." },
