        ...
        private static object BuildIncidentUpsertSchema(bool requireTitle)
        {
            return new
            {
                ...
                properties = new
                {
                    ...
                    regressionLandedCommit = new { type = "string", description = "Optional landed commit hash the regression is attributed to; blank clears it" },
                    recoveryNotes = new { type = "string", description = "Optional recovery notes" },
                    postmortem = new { type = "string", description = "Optional postmortem notes" },
        ...
        private sealed class IncidentUpdateArgs : IncidentUpsertRequest
        {
            ...
            public IncidentUpsertRequest ToUpsertRequest()
            {
                return new IncidentUpsertRequest
                {
                    ...
                    Impact = Impact,
                    RootCause = RootCause,
                    RegressionPurpose = RegressionPurpose,
                    RegressionCause = RegressionCause,
                    RegressionObjectiveId = RegressionObjectiveId,
                    RegressionLandedCommit = RegressionLandedCommit,
