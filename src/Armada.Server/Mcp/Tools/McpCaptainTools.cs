            ...
            register(
                ...
                new
                {
                    ...
                    properties = new
                    {
                        ...
                        apiKey = new { type = "string", description = "Per-captain provider credential override for external-provider-served models (e.g. Zyloo, cun-ai); wins over the provider's host-level environment variable" },
