namespace Armada.Runtimes.Tools
{
    ...
    public class BuiltInToolRegistry
    {
        ...
        /// <param name="argumentsJson">The parsed JSON arguments from the model.</param>
        ...
        public async Task<ToolResult> ExecuteAsync(string toolCallId, string toolName, string argumentsJson, string workingDirectory, CancellationToken cancellationToken)
        {
            ...
            return await executor.ExecuteAsync(toolCallId, argumentsJson, workingDirectory, cancellationToken).ConfigureAwait(false);
        }
