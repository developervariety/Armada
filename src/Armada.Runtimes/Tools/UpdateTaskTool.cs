namespace Armada.Runtimes.Tools
{
    ...
    public class UpdateTaskTool : IToolExecutor
    {
        ...
        /// <param name="argumentsJson">The parsed JSON arguments containing id, status, and optional note.</param>
        ...
        public Task<ToolResult> ExecuteAsync(string toolCallId, string argumentsJson, string workingDirectory, CancellationToken cancellationToken)
        {
            ...
            UpdateTaskArguments request = ToolArgumentParser.Parse<UpdateTaskArguments>(argumentsJson);
            ...
            string statusText = request.Status ?? string.Empty;
        ...
        private sealed class UpdateTaskArguments
        {
