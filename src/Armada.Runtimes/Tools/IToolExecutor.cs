namespace Armada.Runtimes.Tools
{
    ...
    public interface IToolExecutor
    {
        ...
        /// <param name="argumentsJson">The JSON arguments from the LLM.</param>
        ...
        Task<ToolResult> ExecuteAsync(string toolCallId, string argumentsJson, string workingDirectory, CancellationToken cancellationToken);
    }
}
