namespace Armada.Runtimes
{
    ...
    /// cmd.exe ~8KB command-line length limit. On Windows the official installer path is
    /// probed before the PATH/npm fallback so that a stale npm shim cannot silently win.
    /// </remarks>
