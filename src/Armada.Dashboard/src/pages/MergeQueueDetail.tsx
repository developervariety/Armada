  ...
  return (
    <div>
      ...
      <LandingPreviewCard
        ...
        meta={`${entry.branchName} -> ${entry.targetBranch}`}
        unavailableMessage={t('Landing preview is not available for this merge entry yet.')}
        noIssuesMessage={t('This preview found no issues for this merge entry.')}
