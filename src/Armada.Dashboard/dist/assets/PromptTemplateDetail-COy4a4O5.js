import{u as H,y as K,c as Q,r as l,m as W,bJ as X,j as e,L as Z,bR as F,bL as ee,bM as te}from"./index-Cjpw57Wj.js";import{A as ae}from"./ActionMenu-DOpPHh9D.js";import{J as se}from"./JsonViewer-DPBKz_Cy.js";import{S as N}from"./StatusBadge-B2f4Tl9n.js";import{C as ie}from"./ConfirmDialog-BbeSiRSN.js";import{C as ne}from"./CopyButton-BiTq8477.js";import{E as B}from"./ErrorModal-CY1sWXc5.js";import{g as re}from"./duplicates-B-G_43FR.js";import"./index-Cc2YaTxP.js";const le=[{label:"Mission Context",params:[{name:"{MissionId}",description:"Mission identifier"},{name:"{MissionTitle}",description:"Mission title"},{name:"{MissionDescription}",description:"Full mission description"},{name:"{MissionPersona}",description:"Persona assigned to this mission"},{name:"{VoyageId}",description:"Parent voyage identifier"},{name:"{BranchName}",description:"Git branch for this mission"}]},{label:"Vessel Context",params:[{name:"{VesselId}",description:"Vessel identifier"},{name:"{VesselName}",description:"Vessel display name"},{name:"{DefaultBranch}",description:"Default branch (e.g. main)"},{name:"{ProjectContext}",description:"User-supplied project description"},{name:"{StyleGuide}",description:"User-supplied style guide"},{name:"{ModelContext}",description:"Agent-accumulated context"},{name:"{FleetId}",description:"Parent fleet identifier"}]},{label:"Captain Context",params:[{name:"{CaptainId}",description:"Captain identifier"},{name:"{CaptainName}",description:"Captain display name"},{name:"{CaptainInstructions}",description:"User-supplied captain instructions"}]},{label:"Pipeline Context",params:[{name:"{PersonaPrompt}",description:"Resolved persona prompt text"},{name:"{PreviousStageDiff}",description:"Diff from prior pipeline stage"},{name:"{ExistingClaudeMd}",description:"Contents of repo's existing CLAUDE.md"}]},{label:"System",params:[{name:"{Timestamp}",description:"Current UTC timestamp"}]}],oe=["mission","persona","structure","commit","landing","agent"];function be(){const{t:a,formatDateTime:E}=H(),{name:p}=K(),T=Q(),M=l.useRef(null),o=!p,[s,u]=l.useState(null),[L,S]=l.useState(!0),[P,r]=l.useState(""),[w,f]=l.useState(!1),{pushToast:j}=W(),[g,b]=l.useState(""),[C,v]=l.useState("mission"),[c,d]=l.useState(""),[R,x]=l.useState(""),[z,m]=l.useState(!1),[D,I]=l.useState({open:!1,title:"",data:null}),[y,k]=l.useState({open:!1,title:"",message:"",onConfirm:()=>{}}),U=l.useCallback(async()=>{if(o){u(null),b(""),v("mission"),d(""),x(""),m(!1),r(""),S(!1);return}if(p)try{S(!0);const t=await X(p);u(t),b(t.name),v(t.category),d(t.content),x(t.description??""),m(!1),r("")}catch(t){u(null),r(t instanceof Error?t.message:a("Failed to load prompt template."))}finally{S(!1)}},[o,p,a]);l.useEffect(()=>{U()},[U]);function V(t){b(t),m(!0)}function O(t){v(t),m(!0)}function J(t){d(t),m(!0)}function q(t){x(t),m(!0)}async function G(){const t=g.trim(),n=C.trim(),h=R.trim();if(o){if(!t){r(a("Template name is required."));return}if(!n){r(a("Template category is required."));return}if(!c.trim()){r(a("Template content is required."));return}try{f(!0);const i=await F({name:t,category:n,content:c,description:h||void 0,active:!0});u(i),b(i.name),v(i.category),d(i.content),x(i.description??""),m(!1),r(""),j("success",a('Template "{{name}}" created.',{name:i.name})),T(`/prompt-templates/${encodeURIComponent(i.name)}`,{replace:!0})}catch(i){r(i instanceof Error?i.message:a("Create failed."))}finally{f(!1)}return}if(!(!p||!s))try{f(!0);const i=await ee(p,{content:c,description:h||void 0});u(i),b(i.name),v(i.category),d(i.content),x(i.description??""),m(!1),r(""),j("success",a("Template saved."))}catch(i){r(i instanceof Error?i.message:a("Save failed."))}finally{f(!1)}}async function _(){if(s)try{f(!0);const t=await F(re(s));j("success",a('Template "{{name}}" duplicated.',{name:t.name})),T(`/prompt-templates/${encodeURIComponent(t.name)}`)}catch(t){r(t instanceof Error?t.message:a("Duplicate failed."))}finally{f(!1)}}function A(){!s||!s.isBuiltIn||k({open:!0,title:a("Reset to Default"),message:a('Reset "{{name}}" to its built-in default content? Your customizations will be lost.',{name:s.name}),onConfirm:async()=>{k(t=>({...t,open:!1}));try{const t=await te(s.name);u(t),d(t.content),x(t.description??""),m(!1),j("success",a("Template reset to default."))}catch{r(a("Reset failed."))}}})}function $(t){const n=M.current;if(!n)return;const h=n.selectionStart,i=n.selectionEnd,Y=c.substring(0,h)+t+c.substring(i);d(Y),m(!0),requestAnimationFrame(()=>{n.focus(),n.selectionStart=h+t.length,n.selectionEnd=h+t.length})}return L?e.jsx("p",{className:"text-dim",children:a("Loading...")}):!o&&P&&!s?e.jsx(B,{error:P,onClose:()=>r("")}):!o&&!s?e.jsx("p",{className:"text-dim",children:a("Template not found.")}):e.jsxs("div",{children:[e.jsxs("div",{className:"breadcrumb",children:[e.jsx(Z,{to:"/prompt-templates",children:a("Prompt Templates")})," ",e.jsx("span",{className:"breadcrumb-sep",children:">"})," ",e.jsx("span",{children:o?a("Create"):g})]}),e.jsxs("div",{className:"detail-header",children:[e.jsx("h2",{children:o?a("Create Prompt Template"):g}),e.jsx("div",{className:"inline-actions",children:o?e.jsx(N,{status:C||"mission"}):e.jsxs(e.Fragment,{children:[e.jsx(N,{status:s.category}),s.isBuiltIn&&e.jsx(N,{status:"Built-in"}),e.jsx(ae,{id:`template-${s.name}`,items:[{label:"Duplicate",onClick:()=>void _()},{label:"View JSON",onClick:()=>I({open:!0,title:a("Template: {{name}}",{name:s.name}),data:s})},...s.isBuiltIn?[{label:"Reset to Default",danger:!0,onClick:A}]:[]]})]})})]}),e.jsx(B,{error:P,onClose:()=>r("")}),e.jsx(se,{open:D.open,title:D.title,data:D.data,onClose:()=>I({open:!1,title:"",data:null})}),e.jsx(ie,{open:y.open,title:y.title,message:y.message,onConfirm:y.onConfirm,onCancel:()=>k(t=>({...t,open:!1}))}),e.jsx("style",{children:`
