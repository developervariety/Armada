    ...
    public sealed class PlanningSessionCoordinatorSuite : IArmadaTestSuite
    {
        ...
        public TestSuiteDescriptor Build()
        {
            ...
            cases.Add(CaseAsync("opencode_provider_error_is_persisted_as_failed_turn", "OpenCode provider error is persisted as planning failure", TestTags.Negative, async () =>
            {
                ...
                string fixture = (await File.ReadAllTextAsync(Path.Combine(FindRepositoryRoot(), "src", "Test.Shared", "Fixtures", "opencode-api-error.jsonl")).ConfigureAwait(false)).Trim();
