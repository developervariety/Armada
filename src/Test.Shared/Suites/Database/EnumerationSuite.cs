namespace Test.Shared.Suites.Database
{
    ...
    /// <summary>
    /// Descriptors covering enumeration behavior across every persisted entity (fleets, vessels,
    /// missions, voyages, captains, signals, events, docks): pagination page boundaries, ascending
    /// and descending created-date ordering, created-before/after date-range filtering, and
    /// entity-specific filters (fleet, vessel, captain, voyage, mission, status/state, signal type,
    /// unread-only, event type) both alone and combined. The suite is predominantly positive; the
    /// negative cases assert that empty stores, pages beyond the last page, and filters that match
    /// nothing all yield empty result sets with correct totals.
    /// </summary>
    public sealed class EnumerationSuite : IArmadaTestSuite
    {
        #region Public-Methods

        /// <summary>Build the descriptor for the Enumeration suite.</summary>
        ...
        public TestSuiteDescriptor Build()
        {
            ...
            cases.Add(CaseAsync("fleet_enumerate_pagination_returns_correct_pages", "Fleet enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
            ...
            cases.Add(CaseAsync("fleet_enumerate_order_created_descending_returns_newest_first", "Fleet enumerate order created descending returns newest first", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("fleet_enumerate_order_created_ascending_returns_oldest_first", "Fleet enumerate order created ascending returns oldest first", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("fleet_enumerate_created_after_filter_returns_only_newer", "Fleet enumerate created after filter returns only newer", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("fleet_enumerate_created_before_filter_returns_only_older", "Fleet enumerate created before filter returns only older", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("fleet_enumerate_date_range_filter_returns_between", "Fleet enumerate date range filter returns between", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("fleet_enumerate_empty_database_returns_empty", "Fleet enumerate empty database returns empty", TestTags.Negative, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("fleet_enumerate_page_beyond_range_returns_empty_with_correct_total", "Fleet enumerate page beyond range returns empty with correct total", TestTags.Negative, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("vessel_enumerate_pagination_returns_correct_pages", "Vessel enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("vessel_enumerate_fleet_id_filter_returns_only_matching", "Vessel enumerate FleetId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("vessel_enumerate_ordering_works_correctly", "Vessel enumerate ordering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("vessel_enumerate_date_filtering_works_correctly", "Vessel enumerate date filtering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("vessel_enumerate_fleet_id_filter_with_pagination_works_correctly", "Vessel enumerate FleetId filter with pagination works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_pagination_returns_correct_pages", "Mission enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_status_filter_returns_only_matching", "Mission enumerate status filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_vessel_id_filter_returns_only_matching", "Mission enumerate VesselId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_captain_id_filter_returns_only_matching", "Mission enumerate CaptainId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_voyage_id_filter_returns_only_matching", "Mission enumerate VoyageId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_combined_filters_returns_intersection", "Mission enumerate combined filters returns intersection", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_ordering_works_correctly", "Mission enumerate ordering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_date_filtering_works_correctly", "Mission enumerate date filtering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("mission_enumerate_status_filter_with_pagination_works_correctly", "Mission enumerate status filter with pagination works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("voyage_enumerate_pagination_returns_correct_pages", "Voyage enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("voyage_enumerate_status_filter_returns_only_matching", "Voyage enumerate status filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("voyage_enumerate_ordering_works_correctly", "Voyage enumerate ordering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("voyage_enumerate_date_filtering_works_correctly", "Voyage enumerate date filtering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("voyage_enumerate_status_filter_with_pagination_works_correctly", "Voyage enumerate status filter with pagination works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("captain_enumerate_pagination_returns_correct_pages", "Captain enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("captain_enumerate_state_filter_returns_only_matching", "Captain enumerate state filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("captain_enumerate_ordering_works_correctly", "Captain enumerate ordering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("captain_enumerate_date_filtering_works_correctly", "Captain enumerate date filtering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("captain_enumerate_state_filter_with_pagination_works_correctly", "Captain enumerate state filter with pagination works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("signal_enumerate_pagination_returns_correct_pages", "Signal enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("signal_enumerate_to_captain_id_filter_returns_only_matching", "Signal enumerate ToCaptainId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("signal_enumerate_signal_type_filter_returns_only_matching", "Signal enumerate SignalType filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("signal_enumerate_unread_only_filter_returns_only_unread", "Signal enumerate unread only filter returns only unread", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("signal_enumerate_ordering_works_correctly", "Signal enumerate ordering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("signal_enumerate_date_filtering_works_correctly", "Signal enumerate date filtering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("signal_enumerate_combined_filters_work_correctly", "Signal enumerate combined filters work correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_pagination_returns_correct_pages", "Event enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_event_type_filter_returns_only_matching", "Event enumerate EventType filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_captain_id_filter_returns_only_matching", "Event enumerate CaptainId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_mission_id_filter_returns_only_matching", "Event enumerate MissionId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_vessel_id_filter_returns_only_matching", "Event enumerate VesselId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_voyage_id_filter_returns_only_matching", "Event enumerate VoyageId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_ordering_works_correctly", "Event enumerate ordering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_date_filtering_works_correctly", "Event enumerate date filtering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_combined_filters_returns_intersection", "Event enumerate combined filters returns intersection", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("event_enumerate_event_type_with_pagination_works_correctly", "Event enumerate EventType with pagination works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("dock_enumerate_pagination_returns_correct_pages", "Dock enumerate pagination returns correct pages", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("dock_enumerate_vessel_id_filter_returns_only_matching", "Dock enumerate VesselId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("dock_enumerate_captain_id_filter_returns_only_matching", "Dock enumerate CaptainId filter returns only matching", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("dock_enumerate_ordering_works_correctly", "Dock enumerate ordering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("dock_enumerate_date_filtering_works_correctly", "Dock enumerate date filtering works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("dock_enumerate_vessel_id_with_pagination_works_correctly", "Dock enumerate VesselId with pagination works correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("dock_enumerate_combined_vessel_and_captain_filter_returns_intersection", "Dock enumerate combined vessel and captain filter returns intersection", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("all_entities_enumerate_empty_database_returns_zero_results", "All entities enumerate empty database returns zero results", TestTags.Negative, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("all_entities_enumerate_non_matching_filter_returns_zero_with_empty_objects", "All entities enumerate non-matching filter returns zero with empty objects", TestTags.Negative, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("all_entities_enumerate_page_size_one_paginates_correctly", "All entities enumerate page size one paginates correctly", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("all_entities_enumerate_large_page_size_returns_single_page", "All entities enumerate large page size returns single page", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
            ...
            cases.Add(CaseAsync("all_entities_enumerate_pagination_consistent_with_ordering", "All entities enumerate pagination consistent with ordering", TestTags.Positive, async () =>
            {
                using (TestDatabase testDb = await TestDatabaseHelper.CreateDatabaseAsync())
                {
                    SqliteDatabaseDriver db = testDb.Driver;
