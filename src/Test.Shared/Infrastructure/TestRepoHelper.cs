namespace Test.Shared.Infrastructure
{
    ...
    /// <summary>
    /// Helper for creating local bare git repositories for use in end-to-end suites.
    /// Avoids cloning from fake GitHub URLs which causes 500 errors when the server
    /// tries to provision docks for mission assignment. Ported from the retired automated
    /// harness so end-to-end descriptors can register vessels against a real local repo.
    /// </summary>
