namespace Test.Shared.Infrastructure
{
    ...
    public sealed class E2EServerFixture
    {
        ...
        private async Task StartAsync()
        {
            ...
            // StopGracePeriodMs is a 3s const, reduced from 10s against a hang model that never
            // materialised. There is nothing to lower, so the knob is not reintroduced.
