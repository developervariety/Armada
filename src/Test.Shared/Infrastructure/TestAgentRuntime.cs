namespace Test.Shared.Infrastructure
{
    ...
    public class TestAgentRuntime : BaseAgentRuntime
    {
        ...
        // This fork's BaseAgentRuntime exposes no RuntimeType member to override; runtime identity is
        // carried by Name. Kept as a plain property so suites that read it still compile.
        protected Armada.Core.Enums.AgentRuntimeEnum RuntimeType => Armada.Core.Enums.AgentRuntimeEnum.ClaudeCode;
