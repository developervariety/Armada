        ...
        public static List<SchemaMigration> GetMigrations()
        {
            return new List<SchemaMigration>
            {
                ...
                new SchemaMigration(38, "Add merge failure classification columns and mission recovery attempts",
                    @"ALTER TABLE merge_entries ADD COLUMN merge_failure_class TEXT;",
                ...
                new SchemaMigration(47, "Add workflow, delivery, request history, and objective tables",
                    ...
                    @"CREATE TABLE IF NOT EXISTS environments (
                        ...
                        alert_on_regression INTEGER NOT NULL DEFAULT 1,
                    ...
                    @"CREATE TABLE IF NOT EXISTS deployments (
                        ...
                        monitoring_window_ends_utc TEXT,
                        last_monitored_utc TEXT,
                        last_regression_alert_utc TEXT,
                    ...
                    @"CREATE TABLE IF NOT EXISTS objectives (
                        ...
                        backlog_state TEXT NOT NULL,
                        effort TEXT NOT NULL,
                        owner TEXT,
                        target_version TEXT,
                        due_utc TEXT,
                        parent_objective_id TEXT,
                        blocked_by_objective_ids_json TEXT NOT NULL DEFAULT '[]',
                        refinement_summary TEXT,
                        suggested_pipeline_id TEXT,
                        suggested_playbooks_json TEXT NOT NULL DEFAULT '[]',
                        tags_json TEXT NOT NULL DEFAULT '[]',
                        acceptance_criteria_json TEXT NOT NULL DEFAULT '[]',
                        non_goals_json TEXT NOT NULL DEFAULT '[]',
                        rollout_constraints_json TEXT NOT NULL DEFAULT '[]',
                        evidence_links_json TEXT NOT NULL DEFAULT '[]',
                        fleet_ids_json TEXT NOT NULL DEFAULT '[]',
                        vessel_ids_json TEXT NOT NULL DEFAULT '[]',
                        planning_session_ids_json TEXT NOT NULL DEFAULT '[]',
                        refinement_session_ids_json TEXT NOT NULL DEFAULT '[]',
                        voyage_ids_json TEXT NOT NULL DEFAULT '[]',
                        mission_ids_json TEXT NOT NULL DEFAULT '[]',
                        check_run_ids_json TEXT NOT NULL DEFAULT '[]',
                        release_ids_json TEXT NOT NULL DEFAULT '[]',
                    ...
                    @"CREATE INDEX IF NOT EXISTS idx_workflow_profiles_tenant_scope ON workflow_profiles(tenant_id, scope);",
                    ...
                    @"CREATE INDEX IF NOT EXISTS idx_environments_tenant_vessel ON environments(tenant_id, vessel_id);",
                    @"CREATE INDEX IF NOT EXISTS idx_environments_vessel_kind ON environments(vessel_id, kind);",
                    ...
                    @"CREATE INDEX IF NOT EXISTS idx_objectives_user_backlog_priority_rank ON objectives(user_id, backlog_state, priority, rank);",
                ...
                new SchemaMigration(51, "Add durable landing jobs",
                    @"CREATE TABLE IF NOT EXISTS landing_jobs (
                        ...
                        tenant_id TEXT,
                        user_id TEXT,
                        merge_entry_id TEXT NOT NULL UNIQUE,
                        mission_id TEXT,
                        vessel_id TEXT,
                        branch_name TEXT NOT NULL,
                        target_branch TEXT NOT NULL DEFAULT 'main',
                        ...
                        completed_utc TEXT,
                        last_error TEXT,
                        FOREIGN KEY (merge_entry_id) REFERENCES merge_entries(id) ON DELETE CASCADE
                    );",
                ...
                new SchemaMigration(77, "Add coordination claims for cross-session work reservations",
                ...
                new SchemaMigration(83, "Persist vessel preview configuration",
                ...
                new SchemaMigration(86, "Add native captain memory",
                ...
                new SchemaMigration(89, "Persist captain model endpoint links",
                    @"ALTER TABLE captains ADD COLUMN model_endpoint_id TEXT NULL REFERENCES model_endpoints(id) ON DELETE RESTRICT;"
                ),
                new SchemaMigration(90, "Persist Harbor runner enrollments",
                ...
                new SchemaMigration(97, "Persist lane state transitions and Check slot requests",
                ...
                new SchemaMigration(110, "Keep same-order pipeline stages in their submitted order", PipelineStagePositionPersistence.SqliteStatements)
            };
        }
