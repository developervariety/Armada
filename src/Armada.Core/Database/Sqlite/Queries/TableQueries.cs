        ...
        public static List<SchemaMigration> GetMigrations()
        {
            return new List<SchemaMigration>
            {
                ...
                new SchemaMigration(53, "Add code-context intent columns to missions",
                    @"ALTER TABLE missions ADD COLUMN code_context_mode TEXT;",
                    @"ALTER TABLE missions ADD COLUMN code_context_query TEXT;",
                    @"ALTER TABLE missions ADD COLUMN code_context_token_budget INTEGER;",
                    @"ALTER TABLE missions ADD COLUMN code_context_max_results INTEGER;"
                )
            };
        }
