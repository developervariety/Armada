namespace Armada.Core.Database.Sqlite
{
    ...
    public class SqliteDatabaseDriver : DatabaseDriver
    {
        ...
        public SqliteDatabaseDriver(string connectionString, LoggingModule logging)
        {
            ...
            MergeEntries = new SqliteMergeEntryMethods(_ConnectionString);
        }
        ...
        private static List<SchemaMigration> GetMigrations()
        {
            return new List<SchemaMigration>
            {
                ...
                new SchemaMigration(8, "Add merge_entries table for persistent merge queue",
        ...
        private static MergeEntry MergeEntryFromReader(SqliteDataReader reader)
        {
        ...
        private class SqliteMergeEntryMethods : IMergeEntryMethods
        {
            private string _ConnectionString;

            internal SqliteMergeEntryMethods(string connectionString)
            {
                _ConnectionString = connectionString;
            }
