namespace Armada.Core.Database.Mysql.Implementations
{
    ...
    public sealed class JudgeFollowUpMethods : IJudgeFollowUpMethods
    {
        ...
        private static void AddParameters(MySqlCommand cmd, JudgeFollowUp item)
        {
            ...
            cmd.Parameters.AddWithValue("@audit_recommended_action", (object?)item.AuditRecommendedAction ?? DBNull.Value); cmd.Parameters.AddWithValue("@audit_completed_utc", (object?)item.AuditCompletedUtc ?? DBNull.Value);
