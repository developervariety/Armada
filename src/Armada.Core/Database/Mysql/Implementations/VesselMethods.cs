        ...
        public async Task<Vessel> CreateAsync(Vessel vessel, CancellationToken token = default)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(_ConnectionString))
            {
                ...
                using (MySqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    VesselPreviewPersistence.AddParameters(cmd, vessel);
                    BackendMetadataPersistence.AddVessel(cmd, vessel);
                    ...
                    cmd.Parameters.AddWithValue("@created_utc", ToDatabaseTimestamp(vessel.CreatedUtc));
                    cmd.Parameters.AddWithValue("@last_update_utc", ToDatabaseTimestamp(vessel.LastUpdateUtc));
