namespace Armada.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>
    /// SQL Server implementation of landing job database operations.
    /// </summary>
...
#pragma warning restore CS0414
        ...
        public LandingJobMethods(SqlServerDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        private static void AddParameters(SqlCommand cmd, LandingJob job)
        {
