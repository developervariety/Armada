namespace Armada.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>
    /// SQL Server stub for planning session message operations.
    /// </summary>
    public class PlanningSessionMessageMethods : IPlanningSessionMessageMethods
    {
        ...
        {
            return new NotSupportedException("The SQL Server database provider does not store planning sessions; use SQLite or PostgreSQL.");
        }
    }
}
