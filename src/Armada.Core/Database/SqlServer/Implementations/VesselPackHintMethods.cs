namespace Armada.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>
    /// SQL Server implementation of vessel pack-curate hint persistence (v2-F1).
    /// </summary>
    public class VesselPackHintMethods : IVesselPackHintMethods
    {
        ...
        public VesselPackHintMethods(SqlServerDatabaseDriver driver, DatabaseSettings settings, LoggingModule logging)
        {
        ...
        private static void AddParameters(SqlCommand cmd, VesselPackHint hint)
        {
            ...
            cmd.Parameters.AddWithValue("@created_utc", SqlServerDatabaseDriver.ToIso8601(hint.CreatedUtc));
            cmd.Parameters.AddWithValue("@last_update_utc", SqlServerDatabaseDriver.ToIso8601(hint.LastUpdateUtc));
        }

        private static VesselPackHint FromReader(SqlDataReader reader)
        {
            ...
            hint.CreatedUtc = SqlServerDatabaseDriver.FromIso8601(reader["created_utc"].ToString()!);
            hint.LastUpdateUtc = SqlServerDatabaseDriver.FromIso8601(reader["last_update_utc"].ToString()!);
            return hint;
        }
