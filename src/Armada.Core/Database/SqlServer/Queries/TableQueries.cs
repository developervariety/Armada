            ...
            return new List<SchemaMigration>
            {
                ...
                new SchemaMigration(
                    ...
                    CREATE TABLE workflow_profiles (
                        ...
                        CONSTRAINT FK_workflow_profiles_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL,
                        CONSTRAINT FK_workflow_profiles_fleet FOREIGN KEY (fleet_id) REFERENCES fleets(id) ON DELETE SET NULL,
                        CONSTRAINT FK_workflow_profiles_vessel FOREIGN KEY (vessel_id) REFERENCES vessels(id) ON DELETE SET NULL
                    );",
                ...
                new SchemaMigration(
                    ...
                    CREATE TABLE check_runs (
                        ...
                        CONSTRAINT FK_check_runs_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL,
                        CONSTRAINT FK_check_runs_workflow_profile FOREIGN KEY (workflow_profile_id) REFERENCES workflow_profiles(id) ON DELETE SET NULL,
