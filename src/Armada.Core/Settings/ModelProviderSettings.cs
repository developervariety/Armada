namespace Armada.Core.Settings
{
    ...
    /// example-provider) that serves captain models outside the native runtimes.
    /// </summary>
    /// <remarks>
    /// A provider is identified by the namespace prefix of a captain model id, for
    /// example <c>example-provider/claude-fable-5</c> names the <c>example-provider</c> provider and model
    ...
    public class ModelProviderSettings
    {
        ...
        /// <summary>
        /// Human-readable display name for the provider, for example "example-provider".
        /// </summary>
