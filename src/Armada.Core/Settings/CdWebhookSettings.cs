namespace Armada.Core.Settings
{
    ...
    public sealed class CdWebhookSettings
    {
        ...
        /// <summary>
        /// Additional attempts after a retriable failure (5xx, network, timeout, auth). Defaults
        /// to 1, so a transient outage gets two total attempts. Clamped to 0-5.
        /// </summary>
        ...
        /// <summary>
        /// Delay in seconds between retry attempts. Defaults to 2. Values less than or equal to
        /// zero fall back to 2.
        /// </summary>
