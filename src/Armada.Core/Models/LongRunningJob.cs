namespace Armada.Core.Models
{
    ...
    public class LongRunningJob
    {
        ...
        /// <returns>True when the status is Succeeded, Failed or Lost.</returns>
        public static bool IsTerminal(LongRunningJobStatusEnum status)
        {
        ...
        public LongRunningJob CreateSnapshot()
        {
