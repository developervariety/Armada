namespace Armada.Core.Services.Interfaces
{
    ...
    public interface IRemoteTriggerService
    {
        ...
        /// <summary>Write a Wake signal addressed to a coordination-board participant and, when that participant matches the effective AgentWake participant key in a spawn-capable mode, spawn the drainer with the wake text.</summary>
        ...
        /// <summary>Return the effective persistent configuration and transient registration state.</summary>
        AgentWakeStatusSnapshot GetAgentWakeStatus();
    }
}
