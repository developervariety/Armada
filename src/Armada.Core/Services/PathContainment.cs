namespace Armada.Core.Services
{
    ...
    public static class PathContainment
    {
        ...
        public static bool IsWithin(string rootDirectory, string path)
        {
            ...
            return IsWithinNormalized(normalizedRoot, normalizedPath);
        }
        ...
        public static string? TryResolve(string rootDirectory, string relativePath)
        {
            ...
            return IsWithinNormalized(normalizedRoot, Path.TrimEndingDirectorySeparator(fullPath)) ? fullPath : null;
        }
        ...
        private static bool IsWithinNormalized(string normalizedRoot, string normalizedPath)
        {
