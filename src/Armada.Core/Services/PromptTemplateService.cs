    ...
    public class PromptTemplateService : IPromptTemplateService
    {
        ...
        private Dictionary<string, EmbeddedTemplate> BuildEmbeddedDefaults()
        {
            ...
            defaults["mission.model_context_updates"] = new EmbeddedTemplate
            {
                ...
                Description = "Instructions for proposing learned facts when legacy model context is enabled on the vessel.",
                Category = "mission",
                Content =
            ...
            defaults["persona.memory_consolidator"] = new EmbeddedTemplate
            {
                ...
                Content =
                    ...
                    "\n" +
                    "## Operating Modes\n" +
                    "Your brief states a Mode: one of consolidate, reorganize, consolidate-and-reorganize, pack-curate, playbook-curate, persona-curate, captain-curate, or fleet-curate.\n" +
                    ...
                    "- playbook-curate: the brief contains current vessel learned-playbook content plus mission briefs, captain outputs, and search/read/edit evidence. Propose updates to the per-vessel learned-facts playbook when captains had to use Grep, Glob, or armada_code_search to discover facts that should have been captured in the learned playbook. This mode writes markdown playbook content like consolidate, not context-pack hint JSON.\n" +
                    ...
                    "- consolidate / reorganize / consolidate-and-reorganize / playbook-curate: the full proposed playbook content, ready to drop into the playbook table. Markdown, no front matter, ASCII only.\n" +
                    ...
                    "- consolidate / reorganize / consolidate-and-reorganize / playbook-curate: JSON object with added / removed / merged / unchangedCount / evidenceConfidence / missionsExamined (playbook-curate), and notes (free-form paragraph).\n" +
                    ...
                    "- In playbook-curate mode, prefer facts that reduce future blind searches: repo locations, project-specific conventions, validation commands, known pitfalls, or cross-file relationships discovered after search. Do not turn one-off implementation details into durable guidance unless the brief shows repeated evidence or explicit Judge/operator confirmation.\n" +
