...
| Execution and deployment | Local runtime execution and process supervision; the fork self-deploy gate requires backup, restore and candidate proof | Upstream adds model endpoints, API captains, detached Harbor runners and A/B rebuild. These need separate compatibility and acceptance work before use in the fork. |
