...
| Vessel.RequirePassingChecksToLand, ProtectedBranchPatterns, ReleaseBranchPrefix, HotfixBranchPrefix, RequirePullRequestForProtectedBranches, RequireMergeQueueForReleaseBranches | all four | MISSING | MISSING | MISSING | MISSING | MISSING |
...
4. The six Vessel landing-policy fields listed in the table have no schema or mapping on any provider. They retain model defaults after a reload. Their scope and dispatch/landing consumers need a separate behavior decision.
