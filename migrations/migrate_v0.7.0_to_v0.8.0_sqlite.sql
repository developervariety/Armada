-- SQLite manual pre-stage for Armada v0.8.0 backlog/objective support.
-- This mirrors automatic startup migration 43.
...
VALUES (43, 'Add normalized objectives backlog tables', datetime('now'));
