...
- Added a full playbook management surface in the dashboard with list, detail, editing, delete, delivery-mode reference, and ordered selection UX on voyage dispatch flows
...
- Updated README and operator docs for the new playbook lifecycle and remote playbook management flows
