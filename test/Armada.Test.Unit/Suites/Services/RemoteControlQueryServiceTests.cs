namespace Armada.Test.Unit.Suites.Services
{
    ...
    public class RemoteControlQueryServiceTests : TestSuite
    {
        ...
        private class StubGitService : IGitService
        {
            ...
            public Task CreateWorktreeAsync(string repoPath, string worktreePath, string branchName, string baseBranch = "main", bool detached = false, CancellationToken token = default) { throw new NotImplementedException(); }
            ...
            public Task<int> GetCommitCountBetweenAsync(string repoPath, string fromRef, string toRef, CancellationToken token = default) { throw new NotImplementedException(); }
