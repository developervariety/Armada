namespace Armada.Test.Unit
{
    ...
    public class Program
    {
        public static async Task<int> Main(string[] args)
        {
            ...
            runner.AddSuite(new RetryLandingParityTests());
            runner.AddSuite(new VoyageHaltRecallTests());
            runner.AddSuite(new CaptainWriteParityTests());
            runner.AddSuite(new MissionDiffParityTests());
            runner.AddSuite(new MissionUpdateParityTests());
            runner.AddSuite(new BareVoyageParityTests());
            runner.AddSuite(new VesselDeleteParityTests());
            runner.AddSuite(new AdministrativeEventParityTests());
            runner.AddSuite(new VoyageCancelParityTests());
            ...
            runner.AddSuite(new TypedDecisionSubjectLinkTests());
            runner.AddSuite(new TypedDecisionVesselExclusionTests());
            ...
            runner.AddSuite(new TypedMemoryRelevanceAdapterTests());
