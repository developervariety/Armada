namespace Armada.Test.Database
{
    ...
    internal sealed class HarborRunnerEnrollmentMigrationTests
    {
        ...
        /// </summary>
        internal async Task VerifyCombinedAsync(CancellationToken token)
        {
            ...
            {
                DatabaseAssert.Equal(harborVersion, await driver.GetSchemaVersionAsync(token).ConfigureAwait(false), "Combined restart reaches the Harbor version");
